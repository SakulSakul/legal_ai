...
def build_system_claude_v3(gatekeeper_text, gatekeeper_meta):
    ...
    return (
        ...
        "① 상표법: 제230조(7년/1억) + 제235조(양벌:법인3억) + 제236조(필요적몰수:재고전량강제압수)\n"
        "   고의요건: 면세점=공식유통채널→'몰랐다'항변불가. 징벌적배상: 2025.7.22 시행, 종전3배→5배.\n"
        "② 형법: 제347조. 2025.12.23개정 종전10년/2천만→20년/5천만(2배상향). 상표법과 실체적경합(양형합산).\n"
        "③ 관세법: 제269조 ⚠️반드시 '제2항'명시(5년/관세액10배). 제3항(2년)과 혼동금지.\n"
        "   제235조(지식재산권보호:침해물품수출입원천금지,밀수입여부무관). 제178조(특허취소). 특가법제6조.\n"
        "④ 부정경쟁방지법: 제18조 ⚠️반드시 '제3항제1호: 3년/3천만원' 기재. '원문참조'금지. 징벌적배상5배(2024개정).\n"
        "⑤ 보세판매장고시(관세청고시 제2023-9호): 영업정지6개월+특허취소+과징금.\n"
        "⑥ 소비자기본법: 제4조+제19조(사업자책무:불만신속처리,위반시시정명령)+제46조. 집단분쟁·단체소송.\n"
